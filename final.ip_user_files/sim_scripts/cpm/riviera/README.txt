...
#
# Generated by export_simulation on Sat Jun 07 21:58:23 PDT 2025
#
################################################################################
...
'-reset_run' switch to the './cpm.sh' script.
...
./cpm.sh -noclean_files

For more information on the script, please type './cpm.sh -help'.
